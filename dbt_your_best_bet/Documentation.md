...
| home_player_x1        | DOUBLE    | {{ docs("match_home_player_x1") }}X-coordinate of home player 1's position.{{ enddocs }} |
| home_player_x2        | DOUBLE    | {{ docs("match_home_player_x2") }}X-coordinate of home player 2's position.{{ enddocs }} |
| home_player_x3        | DOUBLE    | {{ docs("match_home_player_x3") }}X-coordinate of home player 3's position.{{ enddocs }} |
| home_player_x4        | DOUBLE    | {{ docs("match_home_player_x4") }}X-coordinate of home player 4's position.{{ enddocs }} |
| home_player_x5        | DOUBLE    | {{ docs("match_home_player_x5") }}X-coordinate of home player 5's position.{{ enddocs }} |
| home_player_x6        | DOUBLE    | {{ docs("match_home_player_x6") }}X-coordinate of home player 6's position.{{ enddocs }} |
| home_player_x7        | DOUBLE    | {{ docs("match_home_player_x7") }}X-coordinate of home player 7's position.{{ enddocs }} |
| home_player_x8        | DOUBLE    | {{ docs("match_home_player_x8") }}X-coordinate of home player 8's position.{{ enddocs }} |
| home_player_x9        | DOUBLE    | {{ docs("match_home_player_x9") }}X-coordinate of home player 9's position.{{ enddocs }} |
| home_player_x10       | DOUBLE    | {{ docs("match_home_player_x10") }}X-coordinate of home player 10's position.{{ enddocs }} |
| home_player_x11       | DOUBLE    | {{ docs("match_home_player_x11") }}X-coordinate of home player 11's position.{{ enddocs }} |
| away_player_x1        | DOUBLE    | {{ docs("match_away_player_x1") }}X-coordinate of away player 1's position.{{ enddocs }} |
| away_player_x2        | DOUBLE    | {{ docs("match_away_player_x2") }}X-coordinate of away player 2's position.{{ enddocs }} |
| away_player_x3        | DOUBLE    | {{ docs("match_away_player_x3") }}X-coordinate of away player 3's position.{{ enddocs }} |
| away_player_x4        | DOUBLE    | {{ docs("match_away_player_x4") }}X-coordinate of away player 4's position.{{ enddocs }} |
| away_player_x5        | DOUBLE    | {{ docs("match_away_player_x5") }}X-coordinate of away player 5's position.{{ enddocs }} |
| away_player_x6        | DOUBLE    | {{ docs("match_away_player_x6") }}X-coordinate of away player 6's position.{{ enddocs }} |
| away_player_x7        | DOUBLE    | {{ docs("match_away_player_x7") }}X-coordinate of away player 7's position.{{ enddocs }} |
| away_player_x8        | DOUBLE    | {{ docs("match_away_player_x8") }}X-coordinate of away player 8's position.{{ enddocs }} |
| away_player_x9        | DOUBLE    | {{ docs("match_away_player_x9") }}X-coordinate of away player 9's position.{{ enddocs }} |
| away_player_x10       | DOUBLE    | {{ docs("match_away_player_x10") }}X-coordinate of away player 10's position.{{ enddocs }} |
| away_player_x11       | DOUBLE    | {{ docs("match_away_player_x11") }}X-coordinate of away player 11's position.{{ enddocs }} |
| home_player_y1        | DOUBLE    | {{ docs("match_home_player_y1") }}Y-coordinate of home player 1's position.{{ enddocs }} |
| home_player_y2        | DOUBLE    | {{ docs("match_home_player_y2") }}Y-coordinate of home player 2's position.{{ enddocs }} |
| home_player_y3        | DOUBLE    | {{ docs("match_home_player_y3") }}Y-coordinate of home player 3's position.{{ enddocs }} |
| home_player_y4        | DOUBLE    | {{ docs("match_home_player_y4") }}Y-coordinate of home player 4's position.{{ enddocs }} |
| home_player_y5        | DOUBLE    | {{ docs("match_home_player_y5") }}Y-coordinate of home player 5's position.{{ enddocs }} |
| home_player_y6        | DOUBLE    | {{ docs("match_home_player_y6") }}Y-coordinate of home player 6's position.{{ enddocs }} |
| home_player_y7        | DOUBLE    | {{ docs("match_home_player_y7") }}Y-coordinate of home player 7's position.{{ enddocs }} |
| home_player_y8        | DOUBLE    | {{ docs("match_home_player_y8") }}Y-coordinate of home player 8's position.{{ enddocs }} |
| home_player_y9        | DOUBLE    | {{ docs("match_home_player_y9") }}Y-coordinate of home player 9's position.{{ enddocs }} |
| home_player_y10       | DOUBLE    | {{ docs("match_home_player_y10") }}Y-coordinate of home player 10's position.{{ enddocs }} |
| home_player_y11       | DOUBLE    | {{ docs("match_home_player_y11") }}Y-coordinate of home player 11's position.{{ enddocs }} |
| away_player_y1        | DOUBLE    | {{ docs("match_away_player_y1") }}Y-coordinate of away player 1's position.{{ enddocs }} |
| away_player_y2        | DOUBLE    | {{ docs("match_away_player_y2") }}Y-coordinate of away player 2's position.{{ enddocs }} |
| away_player_y3        | DOUBLE    | {{ docs("match_away_player_y3") }}Y-coordinate of away player 3's position.{{ enddocs }} |
| away_player_y4        | DOUBLE    | {{ docs("match_away_player_y4") }}Y-coordinate of away player 4's position.{{ enddocs }} |
| away_player_y5        | DOUBLE    | {{ docs("match_away_player_y5") }}Y-coordinate of away player 5's position.{{ enddocs }} |
| away_player_y6        | DOUBLE    | {{ docs("match_away_player_y6") }}Y-coordinate of away player 6's position.{{ enddocs }} |
| away_player_y7        | DOUBLE    | {{ docs("match_away_player_y7") }}Y-coordinate of away player 7's position.{{ enddocs }} |
| away_player_y8        | DOUBLE    | {{ docs("match_away_player_y8") }}Y-coordinate of away player 8's position.{{ enddocs }} |
| away_player_y9        | DOUBLE    | {{ docs("match_away_player_y9") }}Y-coordinate of away player 9's position.{{ enddocs }} |
| away_player_y10       | DOUBLE    | {{ docs("match_away_player_y10") }}Y-coordinate of away player 10's position.{{ enddocs }} |
| away_player_y11       | DOUBLE    | {{ docs("match_away_player_y11") }}Y-coordinate of away player 11's position.{{ enddocs }} |

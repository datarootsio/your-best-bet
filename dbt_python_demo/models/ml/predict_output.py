...
from demo_utils.model import RiskRover
from demo_utils.pipeline import preprocess_match_dataset
import logging
...
def model(dbt, session):
    ...
    if dbt.is_incremental:
        ...
        # code doesn't work unfortunately -> I cannot make the model incremental...
        predictions = (
            session.read.table(
